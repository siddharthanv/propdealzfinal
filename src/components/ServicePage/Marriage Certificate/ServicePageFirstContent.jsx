...
function ServicePageFirstContent() {
  ...
  return (
    <div>
      <Container>
        <h1 className="heading">Marriage Certificate</h1>
        <Grid container spacing={5}>
          <Grid item xs={7}>
            ...
            <h3 className="heading">What is Marriage Certificate in India?</h3>
            <p className="content">
            ...
            <h3 className="heading">Who is a Marriage Certificate?</h3>
            <p className="content">
              Don't let the leaking taps or clogged pipes drain your vital
              energy on the plumbing issues. It is very annoying if you find
              leaky or broken taps or for that matter blockage in water supply.
